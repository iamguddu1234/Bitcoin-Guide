...
public final class ActivityAboutBinding implements ViewBinding {
  ...
  private ActivityAboutBinding(@NonNull RelativeLayout rootView, @NonNull CardView logo) {
  ...
  public static ActivityAboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.logo;
      CardView logo = ViewBindings.findChildViewById(rootView, id);
      if (logo == null) {
        break missingId;
      }

      return new ActivityAboutBinding((RelativeLayout) rootView, logo);
    }
