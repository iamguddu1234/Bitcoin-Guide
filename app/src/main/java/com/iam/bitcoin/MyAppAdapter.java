        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (clickedPosition) {
                    ...
                    case 20:
                        Intent intent21 = new Intent("android.intent.action.VIEW", Uri.parse("https://play.google.com/store/apps/details?id=learn.example.learnlinuxatoz&hl=en_IN"));
                        context.startActivity(intent21);
                        break;

                    case 21:
                        Intent intent22 = new Intent("android.intent.action.VIEW", Uri.parse("https://play.google.com/store/apps/details?id=com.guddu.burpsuite&hl=en_IN"));
                        context.startActivity(intent22);
                        break;

                    case 22:
                        Intent intent23 = new Intent("android.intent.action.VIEW", Uri.parse("https://play.google.com/store/apps/details?id=com.swift.learnswift&hl=en_IN"));
