package com.iam.bitcoin.Update;
...
public class A1 extends BaseActivity implements PremiumStatusListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.interm1));
