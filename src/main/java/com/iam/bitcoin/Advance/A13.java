...
public class A13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Derivatives and Futures Markets (Trading Bitcoin Contracts)");
        ...
        RecyclerView a12Rec = findViewById(R.id.a13rec);
        a12Rec.setHasFixedSize(true);
        a12Rec.setLayoutManager(new LinearLayoutManager(this,LinearLayoutManager.VERTICAL, false));
        List<Model> models = new ArrayList<>();
        models.add(new Model(R.string.ad5,R.string.ad6,R.string.ad7));
        models.add(new Model(R.string.ad8,R.string.ad9,R.string.ad10));
        models.add(new Model(R.string.ad11,R.string.ad12,R.string.ad13));
        models.add(new Model(R.string.ad14,R.string.ad15,R.string.ad16));
        models.add(new Model(R.string.ad17,R.string.ad18,R.string.ad19));
        models.add(new Model(R.string.ad20,R.string.ad21,R.string.ad22));
        ...
        AdView mAdView = findViewById(R.id.adViewa13);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Animatoo.INSTANCE.animateSlideRight(A13.this);
